...
app.get('/directors/', async (request, response) => {
  ...
  response.send(
    directorsArray.map(director => convertDirectorDetailsPascalCase(director)),
  )
})
...
app.get('/directors/:directorId/movies/', async (request, response) => {
  ...
  const getDirectorMovieQuery = `SELECT movie_name FROM director INNER JOIN movie ON director.director_id=movie.director_id WHERE director.director_id=${directorId};`
